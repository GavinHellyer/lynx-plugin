...
public class StringTool {
	 ...
	 */
	public static byte[] subBytes(AppLogger logger, byte[] bytes, int start, int end) {
	 ...
	 * @return if -1 child not in parent string,or the child first position found in
	 *         parent;
	 */
	 ...
	 */
	public static String charsetName(AppLogger logger, byte[] data) throws IOException {
		...
		if (encoding != null) {
			...
			return "utf-8"; // default to UTF-8 if no charset is detected
		}
	}
}
